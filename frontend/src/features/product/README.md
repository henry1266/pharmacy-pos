...
| ---- | ------ | ---------- | ----- |
| Envelope drift between legacy responses and ts-rest contract (e.g. null package-unit effective dates) | Medium | Contract regression tests cover nullable package units; monitor for any new envelope drift. | API Contract Enforcer |
