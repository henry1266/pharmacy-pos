...
/**
 * 交易表單組件（頁面版本）
 * 用於創建和編輯交易，作為獨立頁面的一部分
 */
export const TransactionPageForm: React.FC<TransactionPageFormProps> = ({
  onCancel,
  onSubmit,
  editingTransaction,
  copyingTransaction,
  ...
  useEffect(() => {
    ...
    // 重置錯誤
    setErrors({});
  }, [editingTransaction, copyingTransaction, defaultAccountId, defaultOrganizationId]);
