...
export interface BasicInfoSection3Props {
  // 表單資料
...
export const BasicInfoSection3: React.FC<BasicInfoSection3Props> = ({
  formData,
  onFormDataChange,
  errors,
  organizations,
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <TextField
              ...
              onChange={(e) => {
                console.log('[Accounting3] 🔍 描述欄位變更:', {
...
export default BasicInfoSection3;