 ...
 *
 * // 方式 1: 直接導入特定服務
 * import { AccountService } from '@/components/accounting2/core/services';
 *
 * // 方式 2: 導入服務集合
 * import { Services } from '@/components/accounting2/core/services';
 * const accounts = await Services.Account.getAll();
 *
 * // 方式 3: 導入預設服務 (使用別名)
 * import { DefaultAccountService } from '@/components/accounting2/core/services';
 */