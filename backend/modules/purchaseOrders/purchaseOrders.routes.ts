...
type CreatePurchaseOrderRequest =
  ...
  ServerInferRequest<typeof purchaseOrdersContract['createPurchaseOrder']> & {

    req: TsRestRequest<typeof purchaseOrdersContract['createPurchaseOrder']>;

  };

type UpdatePurchaseOrderRequest =

  ServerInferRequest<typeof purchaseOrdersContract['updatePurchaseOrder']> & {

    req: TsRestRequest<typeof purchaseOrdersContract['updatePurchaseOrder']>;
...
const implementation = server.router(purchaseOrdersContract, {
  ...
  createPurchaseOrder: async ({ body, req }: CreatePurchaseOrderRequest) => {
    ...
    try {
      ...
      const userId = (req as { user?: AuthenticatedRequest['user'] }).user?.id;
