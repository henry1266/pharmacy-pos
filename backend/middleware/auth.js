...
// const mongoose = require("mongoose"); // mongoose is not needed for JWT verification

module.exports = function (req, res, next) {
  // // 關閉權限功能 - 直接通過所有請求 (The following code is now disabled)
  // // 將一個虛擬用戶添加到請求對象，以便後續代碼能正常運行
  // // 使用一個有效的 ObjectId 作為虛擬用戶 ID
  // req.user = { id: new mongoose.Types.ObjectId("600000000000000000000000") }; // Use a valid dummy ObjectId
  // return next();
